                ...
                foreach ($goods as $key => $val) {
                    ...
                    <div class="gal_wid background-white box-shadow-div">
                        <div class="title-center">
                            <p class="descript_name color-black">Momoi <?= $name[0] ?></p>
                        </div>
                        <div class="img_wrapper">
                            <a data-go="1" href="<?=WEBURL?>/setepolotno-momoi/<?= $val['id'] ?>" class=""  title="Color : <?= $name[0] ?>">
                                <img src="/img/momoi/<?= $val['name'] ?>" title="momoi-<?= $val['id'] ?>" class="img_gallery img_a trans" />
                            </a>
                        </div>
                        ...
                        <div class="big_btn">
                            <a href="<?=WEBURL?>/setepolotno-momoi/<?= $val['id'] ?>" class="">Детали</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
